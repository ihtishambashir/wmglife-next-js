      ...
      <section className="py-12 sm:py-16 lg:py-20">
        <div className="container-narrow">
          <div className="rounded-2xl border border-gray-200 bg-white shadow-sm p-6 lg:p-8">
            ...
            <form action="https://formspree.io/f/meolyzlw" method="POST" className="mt-6 grid gap-5">
              {/* Honeypot */}
              <input name="_gotcha" type="text" tabIndex={-1} className="hidden" autoComplete="off" />
              {/* Subject for emails */}
